...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260302094954_AddMailDispatchHistory")]
    partial class AddMailDispatchHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.NewsletterSubscriberEntity", b =>
                {
                    ...
                    b.Property<int>("EuroMillionsGridsCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.SyncStateEntity", b =>
                {
                    ...
                    b.Property<string>("CachedArchivesJson")
                        .HasColumnType("text");

                    b.Property<string>("HistoryPageEtag")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");

                    b.Property<DateTimeOffset?>("HistoryPageLastModifiedUtc")
                        .HasColumnType("timestamp with time zone");
